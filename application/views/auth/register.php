...
<head>
    ...
    <title>Register | <?= env("APP_SIMPLE_NAME") ?></title>
            ...
            <div class="auth-box">
                <div>
                    <div class="logo">
                        ...
                        <h4 class="font-medium m-b-20">Buat Akun</h4>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="POST" action="<?= $URL_REGISTER ?>" class="form-horizontal">
                                ...
                                <div class="form-group row ">
                                    <div class="col-12 ">
                                        <input name="nohp" class="form-control form-control-lg" type="phone" required placeholder="No Handphone">
                                    </div>
                                </div>
                                <div class="form-group row ">
                                    <div class="col-12 ">
                                ...
                                <div class="form-group row">
                                    <div class="col-12 ">
                                        <input name="konfirmasi_password" class="form-control form-control-lg" type="password" required placeholder="Konfirmasi Password">
                                    </div>
                                </div>
