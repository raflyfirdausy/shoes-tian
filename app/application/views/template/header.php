...
<body>
    <?php $role = $this->session->userdata(SESSION)["role"]; ?>
    <?php if ($role == USER && $setting["enable_konsultasi"] == "YA") : ?>
        <a href="https://api.whatsapp.com/send?phone=<?= $setting["nowa"] ?>&text=Halo admin shoes and Care" class="float" target="_blank">
                ...
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="<?= base_url() ?>" class="logo">
                            <b class="logo-icon">
                                <img src="<?= asset("img/logo_white.png") ?>" style="width:35px;height:35px;" alt="homepage" class="dark-logo" />
                                <img src="<?= asset("img/logo_white.png") ?>" style="width:35px;height:35px;" alt="homepage" class="light-logo" />
                            </b>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-info text-white m-b-10">
                                    <div class="">
                                        <img src="<?= asset("img/logo_white.png") ?>" alt="user" class="rounded-circle" width="60">
                                    </div>
                                    <div class="m-l-10">
